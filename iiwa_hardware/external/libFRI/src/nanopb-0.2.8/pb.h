...
#define STATIC_ASSERT(COND, MSG) typedef char STATIC_ASSERT_MSG(MSG, __LINE__, \
 ...
 * All kinds of things may break otherwise.. at least all fixed* types.
 *
...
#define PB_DATAOFFSET_OTHER(st, m1, \
    m2) (offsetof(st, m1) - offsetof(st, m2) - pb_membersize(st, m2))
